...
unsigned long long checkMatrix(){
    ...
    while (1){
        ...
        printf("Неверный формат ввода! Введите масив занаво, начиная с неверно введенного элемента\n");
        while (getchar()!='\n');
    }
...
unsigned long long checkMaxtrixLast(){
    ...
    while (1){
        ...
        printf("Неверный формат ввода! Введите занаво последний элемент массива\n");
        while (getchar()!='\n');
    }
