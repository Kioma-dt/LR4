...
long double checkDouble(){
    ...
    while (true){
        ...
        std::cin.clear();
        std::cin.ignore(10000,'\n');
        std::cout << "Неверный формат ввода! Введите матрицу занаво, начиная с неверно введенного элемента\n";
    }
    return input;
}
...
long double checkLast(){
    ...
    while (true){
        ...
        std::cin.clear();
        std::cin.ignore(10000,'\n');
        std::cout << "Неверный формат ввода! Введите занаво последний элемент матрицы\n";
    }
    return input;
}
